        ...
        if usr_cmd == "/start":
            ...
            if(Config.LAZY_MODE == True):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/+aEYTJtwZpalmM2Jl"),
                            InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/Movies_X_Store")
                        ],
                        [
    ...
    async def main(bot: Client, message: Message):
        ...
        if message.chat.type == enums.ChatType.PRIVATE:
            ...
            if message.from_user.id in Config.BANNED_USERS:
                await message.reply_text("ꜱᴏʀʀʏ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ!\n\nContact [Support Group](https://t.me/+aEYTJtwZpalmM2Jl)",
                                        disable_web_page_preview=True)
                return
                    ...
                    [
                        [
                            InlineKeyboardButton("⚡️SФUЯCΞ CФDΞS ФF ß⊕Γ",
                                                url="https://t.me/+aEYTJtwZpalmM2Jl")
                        ],
                        [
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/Movies_X_Store")
                        ],
                        [
                            InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                            InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
            ...
            if Config.UPDATES_CHANNEL:
                ...
                try:
                    ...
                    if user.status == "kicked":
                        await cmd.message.edit(
                            text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/+aEYTJtwZpalmM2Jl).",
                            disable_web_page_preview=True
                        )
                        return
                    ...
                    await cmd.message.edit(
                        text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/+aEYTJtwZpalmM2Jl).",
                        disable_web_page_preview=True
                    )
                    return
            if(Config.LAZY_MODE == True):
